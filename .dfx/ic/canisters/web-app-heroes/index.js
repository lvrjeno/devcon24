...
import { idlFactory } from './web-app-heroes.did.js';
export { idlFactory } from './web-app-heroes.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.CANISTER_ID_WEB_APP_HEROES;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./web-app-heroes.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the web-app-heroes canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./web-app-heroes.did.js")._SERVICE>}
 */
export const web_app_heroes = createActor(canisterId);
